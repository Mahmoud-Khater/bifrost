...
export default function LogsPage() {
	...
	useEffect(() => {
		const refreshDefaultsIfStale = () => {
			...
			// Only slide back to default 24h if the timestamps still match the initial defaults
	...
	const {
		...
		{ filters, pagination },
		{
			...
			// Otherwise respect the user's polling toggle (5s, period-driven, or off).
	...
	// Period + polling: update URL timestamps every 5s so filters args stay fresh and
	// RTK automatically refetches all three queries when args change.
